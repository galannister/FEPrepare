...
with open('psfgen','w') as outfile:
  ...
  outfile.write("mol load pdb /var/www/html/FEPrepare/media/downloads/complex.pdb\n")
  ...
  outfile.write("topology /var/www/html/FEPrepare/media/downloads/top_opls_aam.inp\n")
  outfile.write("topology /var/www/html/FEPrepare/media/downloads/ligand.rtf\n")
