...
with open('/var/www/html/Feprepare/media/downloads/psfgen','w') as outfile:
  outfile.write("mol delete all\n")
  outfile.write("mol load pdb /var/www/html/complex.pdb\n")
  ...
  outfile.write("topology top_all36_prot.rtf\n")
  outfile.write("topologytop_all36_lipid.rtf\n")
  outfile.write("topology top_all36_na.rtf\n")
  outfile.write("topology top_all36_carb.rtf\n")
  outfile.write("topology top_all36_cgenff.rtf\n")
  outfile.write("topology ligand.rtf\n")
  outfile.write("topology toppar_all36_carb_glycopeptide.str\n")
  outfile.write("topology toppar_water_ions_namd.str\n")
