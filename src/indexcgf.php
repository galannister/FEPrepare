...
<html lang="en">
   ...
   <body style="text-align: center;">
    ...
    <div class="row1">
		...
		<div>
	       <p style="float:left; width:100px;height:50px; margin-left: 47rem; "><input class="btn btn-primary" type="button" name ="LigParGen" value="LigParGen Files" onclick="location.href='indexlpg.php'" /> </p>
          	</div>
	     <div>
	       <p style="float:right; width:100px;height:50px; margin-right: 49rem; "><input class="btn btn-primary" type="button" name ="CGenFF" value="CGenFF Files" onclick="location.href='indexcgf.php'" /> </p>
             </div>
	</div>
  	<br></br>
	<br></br>
	...
	<h4>Upload all requested files in order to proceed:<br></br></h4>
            <form action="uploadcgf.php" method="post" enctype="multipart/form-data">
             <div class="col-sm">
                    Select the reference ligand .pdb file<input name="fileToUpload[]" id="fileToUpload" type="file" accept=".pdb" multiple> Select the mutant ligand .pdb file<input name="fileToUpload[]" id="fileToUpload" type="file" accept=".pdb" multiple>
             </div>
             <div class="col-sm">
                    Select the reference ligand &nbsp;.str &nbsp;file<input name="fileToUpload[]" id="fileToUpload" type="file" accept=".str" multiple> Select the mutant ligand &nbsp;.str &nbsp;file<input name="fileToUpload[]" id="fileToUpload" type="file" accept=".str" multiple>
             </div>
                  <br>
