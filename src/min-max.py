...
fileA = sys.argv[1]
fileB = sys.argv[2]
with open('/var/www/html/Feprepare/media/downloads/complex/min-max_center', 'w') as outfile:  
...
with open('/var/www/html/Feprepare/media/downloads/solvent/min-max_center', 'w') as outfile2:  
