#update fep files.
#Stamatia Zavitsanou
#to execute type in command line python fep.py
...
thirdcom=[];thirdsol=[];new=[];new2=[]
###########################################################
print(d1.lateruse)
for i in range(len(d1.lateruse)):
    if (d1.lateruse[i]).startswith('A'):
      n = (d1.lateruse[i]).strip()
      if len(n) == 2:
        new.append(n[1])
      if len(n) == 3:
        new.append(n[1]+n[2])
    ...
    if (d1.lateruse[i]).startswith('B'):
      n2 = (d1.lateruse[i]).strip()     
...
##if there is a Cl or Br in the file probably the coordinates are wrong so we gotta write them correctly from ligand.pdb file
         if ohh[0]=='C' and ohh[1]=='l' or ohh[0]=='B' and ohh[1]=='r': 
            flaga=1
            ...
            for linepdb in pdb:
                ...
                if linepdb.startswith('ATOM'):
                 ...
                 ohpdb=dataatompdb[2]
                 if ohpdb[0]=='C' and ohpdb[1]=='l' or ohpdb[0]=='B' and ohpdb[1]=='r':
                  o=ohpdb[0]
                  t=ohpdb[1]
  ...
  for line2 in f2:
    ...
    if line2.startswith('ATOM'):
        ...
        if f=='X':
         ...
         ohh2=oh2.strip()
##if there is a Cl or Br in the file probably the coordinates are wrong so we gotta write them correctly from ligand.pdb file
         if ohh2[0]=='C' and ohh2[1]=='l' or ohh2[0]=='B' and ohh2[1]=='r': 
            flagb=1
            pdb=open('ligand.pdb', 'r')
            for linepdb in pdb:
                linepdb = linepdb.strip()
         ...
         if dataatom2[2] in new:  
            if flagb==1:
              ...
              for i in range(len(x1)):
                  ...
                  outfile2.write("%6s" %("-1.00"))
                  outfile2.write("%9s" %(dataatom2[11]))
                  outfile2.write("%3s\n" %(o+t))
                  j=j+1
                  break;
...
with open(pdbcom) as f3:
 with open('ionized_complex_out.pdb', 'w') as outfile3:
  for line3 in f3:
    line3 = line3.strip()
    flagc=0
    if line3.startswith('ATOM'):
        ...
        if f=='X':
         ...
         ohh3=oh3.strip()
##if there is a Cl or Br in the file probably the coordinates are wrong so we gotta write them correctly from ligand.pdb file
         if ohh3[0]=='C' and ohh3[1]=='l' or ohh3[0]=='B' and ohh3[1]=='r': 
            flagc=1
            pdb=open('ligand.pdb', 'r')
            for linepdb in pdb:
                linepdb = linepdb.strip()
         ...
         if dataatom3[2] in new:  
            if flagc==1:
              ...
              for i in range(len(x1)):
                  ...
                  outfile3.write("%9s" %(dataatom3[11]))
                  outfile3.write("%3s\n" %(o+t))
                  k=k+1
                  break;
...
with open(pdbsol) as f4:
 with open('ionized_solvent_out.pdb', 'w') as outfile4:
  for line4 in f4:
    line4 = line4.strip()
    flagd=0
    if line4.startswith('ATOM'):
        ...
        if f=='X':
         ...
         ohh4=oh4.strip()
##if there is a Cl or Br in the file probably the coordinates are wrong so we gotta write them correctly from ligand.pdb file
         if ohh4[0]=='C' and ohh4[1]=='l' or ohh4[0]=='B' and ohh4[1]=='r': 
            flagd=1
            pdb=open('ligand.pdb', 'r')
            for linepdb in pdb:
                linepdb = linepdb.strip()
         ...
         if dataatom4[2] in new:  
            if flagd==1:
              ...
              for i in range(len(x1)):
                  ...
                  outfile4.write("%9s" %(dataatom3[11]))
                  outfile4.write("%3s\n" %(o+t))
                  k=k+1
                  break;
            ...
            if flagd==1:
             ...
             for i in range(len(x1)):
              ...
              outfile4.write("%9s" %(dataatom4[11]))
              outfile4.write("%3s\n" %(o+t))
              k=k+1
              break;
            else:
