...
###########################################################
with open(com) as f1:
 with open('media/downloads/complex/ionized_new.fep', 'w') as outfile:
  for line1 in f1:
    line1 = line1.strip()
    flaga=0
...
############################################################################
with open(sol) as f2:
 with open('media/downloads/solvent/ionized_new.fep', 'w') as outfile2:
  for line2 in f2:
    line2 = line2.strip() 
    flagb=0
...
with open(pdbcom) as f3:
 with open('media/downloads/complex/ionized_new.pdb', 'w') as outfile3:
  for line3 in f3:
    line3 = line3.strip()
    flagc=0
...
with open(pdbsol) as f4:
 with open('media/downloads/solvent/ionized_new.pdb', 'w') as outfile4:
  for line4 in f4:
    line4 = line4.strip()
    flagd=0
