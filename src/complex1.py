...
eightth2=[]
filein= sys.argv[1]
with open('complex.pdb', 'w') as outfile:  ###auto tha pareis
    with open(filein, 'r') as infile:   ####allazeis edw
        ...
        for i in range(0,len(lines)):
            ...
            if ena[i]!='END':
                ...
                outfile.write("TER\n")
                print("LUL")
                with open('ligand.pdb') as infile2:  ####allazeis edw, to pairneis apo to dual2
